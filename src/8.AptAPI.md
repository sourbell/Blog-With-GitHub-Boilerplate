...
- Member
    ...
    post /dashboard/statistics/member
...
- Coach / Club Admin 
    get /dashboard/statistics/coach

    ``` javascript
    {
        "calories": 137708.19,
        "iqPoints": 34600.65,
        "workoutTimes": 505, //Session 总次数
        "workoutSeconds": 7974060， //Session 总时长
        "memberCount": 45,
        "coachCount": 2,
    }
    ```
    
    post /dashboard/statistics/coach
...
- Accuro Admin 
    get /dashboard/statistics/accuro
    ...
    post /dashboard/statistics/accuro
