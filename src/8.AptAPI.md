...
get /dashboard/build-classes/page/{page}


32, 创建 Class

put /dashboard/build-classes


33, 修改 Class Name

post /dashboard/build-classes/{classId}
...
delete /dashboard/build-classes/{classId}

35, 获取 Class Detail

get /dashboard/build-classes/{classId}

36, 为 Class 增加 Section

put /dashboard/build-classes/{classId}/sections
...
post /dashboard/build-classes/{classId}/sections/{sectionId}
...
delete /dashboard/build-classes/{classId}/sections/{sectionId}
