...
post /dashboard/accounts/license/page/{page}
...
post /dashboard/accounts/license/actions/generate-new-code
...
27, 删除 License，只能删除未使的

delete /dashboard/accounts/license/{licenseId}


28, 将用户升级为 Basic 用户或 Plus 用户，自动生成一个 License 并激活
